...
%\todo{justify that are evidences that show that many workflows fit in our approach (a relevant set of them). Justify that in this work we are assuming that we have a reliable network. We are targeting reproducibility, not replicability. We are not targeting large scale reproducibility}}
...
%\todo{step 10, open to new technologies, in this paper we introduce our current use case}
