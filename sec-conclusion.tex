...
\rev{As introduced before, in this work we focus on the execution aspects
of a workflow, not considering the experimental data as part of the 
reproducibility process. Including it during the description of the
workflow, using it as a decision criteria when generating an infrastructure
specification would lead to a more effective process. We aim to study
how network capabilities or extra data volumes can be included as 
part of the specification process, reducing the data-related issues 
...
network platforms. \rev{Currently, our approach is able to represent multi-node infrastructures,
even though in this work we have only analyzed and reproduced workflows that
were configured to use a single node environment}.
