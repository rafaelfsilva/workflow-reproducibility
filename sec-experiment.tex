...
\feedback{@Oscar:  you can only evaluate if you have a research hypothesis to validate.
If not, you are only doing experimentation, which is what you do in this section}

\note{Idafen: I've modified the title of this section and checked through the text the mentions to
evaluation, and changed for experimentation. However we still have to discuss this.}
...
In this section, we instantiate the semantic models described in this paper
...
\begin{figure*}[!htb]
	...
	\note{Missing dependency arrows between Condor and Java and wget}
\end{figure*}
...
In all cases, ISA is able to generate the abstract plan either as a PRECIP or 
