...
\note{Idafen, are the Harware and C. Resources the same across all workflows? If yes, we should move the text to the beginning of the section, and just describe into paragraphs the differences for each workflow.}
