...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=.75\linewidth]{figures/annotations-montage}
	\vspace{-10pt}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=.75\linewidth]{figures/annotations-genome}
	\vspace{-10pt}
...
Results show that the VM execution environments deployed by all scripts are equivalent 
to the former ones. To check that not only the workflows are successfully executed but also 
...
included in the Research Object (RO)~\cite{researchObjects} associated with this 
work~\cite{research-object}. This RO also contains pointers to the software and resources 
