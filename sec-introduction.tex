...
%\note{Need to be more e-health oriented.}
%\note{Idafen, go though the paper focusing on what's new compared to previous work (citing REPPAR14 paper)}
...
model as result of our previous work, 2) and study of two new life sciences workflows based on genomic processing applications,
 and 3) how the new features of our approach apply to them and also to the previous astronomy workflow application. 

 \note{Add what is new in this work. I added a list of the main contributions of this paper}.
