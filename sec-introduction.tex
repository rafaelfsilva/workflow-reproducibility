...
shared. Since workflows formally describe the sequence of computational and data 
...
Semantics have been proposed as a way for attaining curation and preservation of the digital 
...
obtain a new equivalent infrastructure. We conduct a practical evaluation using real scientific 
