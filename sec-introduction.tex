...
private or public). \rev{One may argue that it would be easier to keep and share VM images (or
...
Cloud platforms. \rev{In this work, we study three real and representative production 
...
to single computer experiments, which covers a wide range of computational 
experiments.}
...
The \rev{first iteration of the semantic models for representing } computational 
...
our framework \rev{based on the result of our previous work, including a new 
...
\rev{ and their related challenges with respect to previous cases}; and 3)~a 
practical evaluation of the framework with the new features for the astronomy 
workflow as well as \rev{to the } new life science workflows. 
