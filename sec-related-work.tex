...
\rev{Although this approach avoids storing VM images, it still requires 
...
retrieving an analyzing genomic data. \rev{This approach has proved to be 
successful in several cases, however workflows are strongly dependent of
...
management standard that allows the definition of declarative templates 
...
\path{swo:has_version} and \path{wstack:hasVersion}, even tough their 
